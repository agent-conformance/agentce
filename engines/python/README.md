...
This is a **placeholder release** that reserves the package name. The engine is under active development; the specification is in the repository at `docs/SPEC.md`.
