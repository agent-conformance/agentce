---
title: AgentCE SARIF results (profile)
description: The subset of SARIF 2.1.0 that AgentCE emits as results.sarif (SPEC 9), so CI can gate on non-conformant controls with a format it already reads, GitH
---
