---
title: AgentCE reproducibility manifest
description: 'manifest.json in the report directory (SPEC 8.4): the engine, the digests of every input, the digests of every output, and the run metadata. A verifie'
---
