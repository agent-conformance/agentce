---
title: AgentCE deviation register
description: 'deviations.yaml (SPEC 6.5): accepted or temporary departures from a control, each with a rationale, a compensating control, an owner, an approver, an '
---
