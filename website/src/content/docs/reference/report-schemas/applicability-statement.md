---
title: AgentCE applicability statement
description: 'applicability-statement.json (SPEC Appendix F): which controls apply to a subject and why, the observed versus declared decision types, drift findings'
---
