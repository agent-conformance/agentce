---
title: AgentCE assertions
description: 'assertions.json (SPEC 9.4): one machine-readable record per (control, subject), the outcome with its evidence pointers, violations, and population cou'
---
