---
title: AgentCE integrity result
description: 'An IntegrityResult (SPEC 6.6, Appendix F): the verification outcome for one integrity stream, so a report consumer sees exactly which streams were ver'
---
