---
title: AgentCE probe specification
description: Served at its canonical IRI, /spec/rules/probe.schema.json.
---
...
[View the schema](https://agent-conformance.org/spec/rules/probe.schema.json) (`https://agent-conformance.org/spec/rules/probe.schema.json`).
