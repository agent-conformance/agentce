---
title: AgentCE control
description: Served at its canonical IRI, /spec/rules/control.schema.json.
---
...
[View the schema](https://agent-conformance.org/spec/rules/control.schema.json) (`https://agent-conformance.org/spec/rules/control.schema.json`).
