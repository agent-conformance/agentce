---
title: DAT control family
description: 4 control(s) in the DAT family.
---

4 control(s) in the EU AI Act base catalog, crosswalked to Art. 10. Clause numbers only are cited; standard text is never reproduced.
