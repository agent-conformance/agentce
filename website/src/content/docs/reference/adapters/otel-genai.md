---
title: otel-genai adapter
description: Implements the adapter contract of **SPEC §12** (`§12.1` contract, `§12.2` v1 adapters, `§12.3` fixtures and support matrix) for OpenTelemetry GenAI a
---
...
See the [adapter README](https://github.com/agent-conformance/agentce/blob/main/adapters/otel-genai/README.md) for the full source-to-event mapping, fixtures, and the support matrix.
