...
description: Implements the adapter contract of **SPEC §12** (`§12.1` contract, `§12.2` v1 adapters — the `identity` adapter is marked v1.1; `§12.3` fixtures and s
---
...
See the [adapter README](https://github.com/agent-conformance/agentce/blob/main/adapters/identity/README.md) for the full source-to-event mapping, fixtures, and the support matrix.
