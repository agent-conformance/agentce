---
title: Verifying AgentCE artifacts
description: 'This document is the verification procedure for the Agent Conformance Engine (SPEC §8.7, §9.1): the cryptographic primitives the engine uses and where'
---
...
mitigations are catalogued in [the threat model](/explanation/threat-model/).
