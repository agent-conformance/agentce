...
| [`agentce collect`](collect.md) | run a scheduled collection job over sources with a local export, or plan one |
...
| [`agentce ingest`](ingest.md) | adapt a real adapter export into an evidence bundle |
