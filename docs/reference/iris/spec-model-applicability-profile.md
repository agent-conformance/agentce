...
[View the schema](../../../spec/model/generated/json-schema/applicability-profile.schema.json) (`https://agent-conformance.org/spec/model/applicability-profile.schema.json`).
